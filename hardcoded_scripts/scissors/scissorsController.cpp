...
#include <cstdio>
#include <regex>
#include "/home/rob8/Robotica24/roboticaSourceCode/roboticaFunctions.h"
...
int main() {
    ...
    while(true) {
        std::string pythonFilepath = "python3 /home/rob8/Robotica24/hardcoded_scripts/scissors/"; // general filepath for the python scripts
        std::string commandComputerVision = pythonFilepath + "scissorsCV.py"; // computer vision script
        std::string commandRotateServos = pythonFilepath + "scissorsServo.py"; // servo command script
